...
const Headers = ({ setActiveTab }) => {
  ...
  return (
    <>
      <AppBar position="fixed" className="app-bar" elevation={3}>
        <Toolbar>
          <Avatar src="./g.jpg" alt="Profile Picture" className="small-avatar" />
          <Typography
            variant="h6"
            sx={{ flexGrow: 1, fontWeight: "bold", fontSize: 18, marginTop: "10px" }}
          >
            Portfolio
          </Typography>
          <Box sx={{ display: "flex", gap: 5 }}>
            <a href="https://www.linkedin.com/in/giridharan-chandrababu-95a236b1/" target="_blank" rel="noopener noreferrer">
              <LinkedIn />
            </a>
            <a href="https://github.com/giridharanbabu" target="_blank" rel="noopener noreferrer">
              <GitHub />
            </a>
          </Box>
        </Toolbar>
      ...
      <Box className="header" />
        ...
        >
          <Box className="profile-container">
                <Avatar 
                src="./WhatsApp Image 2025-02-11 at 07.50.04_1f032223.jpg" 
                alt="Profile Picture" 
                className="profile-avatar"
                sx={{ width: 150, height: 150, boxShadow: "5px 5px 10px rgba(0, 0, 0, 0.2)" }}
        />    <Card sx={{ backgroundColor: "inherit" }} className="profile-card">
              <Box sx={{ display: "flex", flexDirection: "column", padding: "20px" }}>
                <Typography variant={isMobile ? "h6" : "h5"} fontWeight="bold" className="profile-card-text">
                  GiriDharan Chandrababu
                </Typography>
                <Typography variant={isMobile ? "body2" : "body1"} className="profile-card-text">
                  Data Scientist & AI Engineer
                </Typography>
                <Typography variant="body2" className="profile-card-text">
                  Toronto, Canada
                </Typography>
                <Box className="get-in-touch-button">
                  <Button variant="outlined" size="small" sx={{ fontSize: "10px" }} onClick={handleScrollToContact}>
                    Get in touch
                  </Button>
                </Box>
              </Box>
          ...
          <Box className="resume-button">
            <Button variant="contained" sx size="small" onClick={handleDownload}>
              Download Resume
            </Button>
          </Box>
        </Box>
