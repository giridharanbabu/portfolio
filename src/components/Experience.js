...
import Typography from "@mui/joy/Typography";
import CardContent from "@mui/joy/CardContent";
import "./experience.scss"; // Import CSS file
  ...
  return (
    <>
      <Card className="experience-card">
        <Typography variant="h2" className="experience-title">
          Experience
        </Typography>

        <div className="experience-list">
          {Experience_list.map((experience, index) => (
            <Card key={index} variant="outlined" className="experience-item">
              <CardOverflow>
                <IconButton aria-label="Profile" sx={{
                      position: "absolute",
                      zIndex: 1,
                      borderRadius: "50%",
                      right: "1rem",
                      bottom: "-1rem",
                      transform: "translateY(100%)",
                    }}size="md" className="profile-icon">
                  <Avatar />
                </IconButton>
              </CardOverflow>
              <CardContent>
